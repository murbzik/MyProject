    ...
    (function($) {
            ...
            $.widget = function(name, base, prototype) {
                ...
                $.extend(constructor, existingConstructor, {
                    version: prototype.version, // Copy the object used to create the prototype in case we need to
            ...
            var dataSpace = "ui-effects-",
                ...
                dataSpaceAnimated = "ui-effects-animated", // Create a local jQuery because jQuery Color relies on it and the
            ...
            (function(jQuery, undefined) {
                    var stepHooks = "backgroundColor borderBottomColor borderLeftColor borderRightColor " + "borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor", // Plusequals test for += 100 -= 100
                        ...
                        \s * (\d {
                            ...
                            1,
                            3
                        })\ s * ( ? : , \s * (\d ? ( ? : \.\d + ) ? )\ s * ) ? \) / , parse: function(execResult) {
        ...
        createPlaceholder: function(element) {
            ...
            if (/^(static|relative)/.test(cssPosition)) {
                ...
                placeholder = $("<" + element[0].nodeName + ">").insertAfter(element).css({
                    ...
                    visibility: "hidden", // Margins need to be set to account for margin collapse
                    marginTop: element.css("marginTop"),
                    marginBottom: element.css("marginBottom"),
                    marginLeft: element.css("marginLeft"),
                    marginRight: element.css("marginRight"),
...
var effectsEffectBounce = $.effects.define("bounce", function(options, done) {
    var upAnim, downAnim, refValue, element = $(this), // Defaults:
        ...
        times = options.times || 5, // Number of internal animations
        anims = times * 2 + (show || hide ? 1 : 0),
        speed = options.duration / anims,
        easing = options.easing, // Utility:
...
var effectsEffectPulsate = $.effects.define("pulsate", "show", function(options, done) {
    var element = $(this),
        ...
        show = mode === "show",
        hide = mode === "hide",
        showhide = show || hide, // Showing or hiding leaves off the "last" animation
            ...
            keydown: function(event) {
                ...
                switch (event.keyCode) {
                    ...
                    case keyCode.DOWN:
                        ...
                        break;
                    case keyCode.ENTER: // when menu is open and has focus
                        if (this.menu.active) {
...
//>>css.theme: ../../themes/base/theme.css
var controlgroupCornerRegex = /ui-corner-([a-z]) {
2, 6
}
/g;
    ...
    _createButtons: function() {
        ...
        $.each(buttons, function(name, props) {
            ...
            buttonOptions = {
                ...
                showLabel: props.showLabel, // Deprecated options
                icons: props.icons,
                text: props.text
            };
            delete props.click;
...
var widgetsSlider = $.widget("ui.slider", $.ui.mouse, {
    ...
    options: {
        ...
        classes: {
            ...
            "ui-slider-handle": "ui-corner-all", // Note: ui-widget-header isn't the most fittingly semantic framework class for this
...
var widgetsSortable = $.widget("ui.sortable", $.ui.mouse, {
    ...
    _mouseStart: function(event, overrideHandle, noActivation) {
        ...
        $.extend(this.offset, {
            ...
            parent: this._getParentOffset(), // This is a relative to absolute position minus the actual position calculation -
...
$.widget("ui.spinner", {
    ...
    _refresh: function() {
        this.element.attr({
            ...
            "aria-valuemax": this.options.max, // TODO: what should we do with values that can't be parsed?
    ...
    _tabKeydown: function(event) {
        ...
        switch (event.keyCode) {
            ...
            case $.ui.keyCode.HOME:
                selectedIndex = 0;
                break;
            case $.ui.keyCode.SPACE: // Activate only, no collapsing
                event.preventDefault();
                clearTimeout(this.activating);
                this._activate(selectedIndex);
                return;
            case $.ui.keyCode.ENTER: // Toggle (cancel delayed activation, allow collapsing)
                event.preventDefault();
                clearTimeout(this.activating);
...
$.widget("ui.tooltip", {
    ...
    options: {
        ...
        hide: true, // Disabled elements have inconsistent behavior across browsers (#8661)
